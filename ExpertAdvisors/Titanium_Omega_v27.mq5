//+------------------------------------------------------------------+
//|                                     Titanium_Omega_v27.mq5       |
//|                     © 2025, Systemic Trading Engineering         |
//|       Versiyon: 27.0 (ULTIMATE - RECOVERY + FUND MANAGEMENT)     |
//+------------------------------------------------------------------+
...
input string   InpComment         = "Titanium Omega v27"; // İşlem Yorumu
...
void OnTick()
{
   ...
   if(InpShowDashboard || InpForceShowDashboard)
   {
      ...
      string dash = "+========================================+\n";
      dash += "|     TITANIUM OMEGA v27.0 ULTIMATE     |\n";
      dash += "+========================================+\n";
