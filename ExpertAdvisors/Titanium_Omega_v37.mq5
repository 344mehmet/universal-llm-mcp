//+------------------------------------------------------------------+
//|                                     Titanium_Omega_v37.mq5       |
//|                     © 2025, Systemic Trading Engineering         |
//|  Versiyon: 37.0 (AUTO TEST MODE - INSTANT TRADE ON INIT)        |
//+------------------------------------------------------------------+
...
input string   InpComment         = "Titanium Omega v37"; // İşlem Yorumu
...
int OnInit()
{
   ...
   Print("✅ v37: Tüm modüller başlatıldı (AUTO TEST MODE).");
   
   // v37 - Başlangıç Mesajı
   Print("=");
   Print("TITANIUM OMEGA v37.0 AUTO TEST MODE BAŞLATILDI");
...
void OnTick()
{
   ...
   if(InpShowDashboard || InpForceShowDashboard)
   {
      ...
      string dash = "+================================================+\n";
      dash += "|   TITANIUM OMEGA v37.0 AUTO TEST MODE         |\n";
      dash += "+================================================+\n";
