//+------------------------------------------------------------------+
//|                                     Titanium_Omega_v38.mq5       |
//|                     © 2025, Systemic Trading Engineering         |
//|  Versiyon: 38.0 (FULL AUTO - SMART MANUAL TRADE MANAGER)        |
//+------------------------------------------------------------------+
...
input string   InpComment         = "Titanium Omega v38"; // İşlem Yorumu
...
int OnInit()
{
   ...
   Print("✅ v38: Tüm modüller başlatıldı (FULL AUTO MODE).");
   
   // v38 - Başlangıç Mesajı
   Print("=");
   Print("TITANIUM OMEGA v38.0 FULL AUTO MODE BAŞLATILDI");
   Print("Bakıye: ", AccountInfoDouble(ACCOUNT_BALANCE), " ", AccountInfoString(ACCOUNT_CURRENCY));
   Print("👤 Manuel İşlem Yönetimi: AKT İF");
   Print("   - Yanlış yöndeki manuel işlemler → OTOMATİK KAPAT");
   Print("   - Doğru yöndeki manuel işlemler → SL/TP EKLE");
   Print("Auto Test Trade: ", InpAutoTestTrade ? "AKTIF" : "PASIF");
   Print("=");
...
void OnTick()
{
   ...
   if(InpShowDashboard || InpForceShowDashboard)
   {
      ...
      string dash = "+================================================+\n";
      dash += "|   TITANIUM OMEGA v38.0 FULL AUTO MODE         |\n";
      dash += "+================================================+\n";
