//+------------------------------------------------------------------+
//|                                     Titanium_Omega_v40.mq5       |
//|                     © 2025, Systemic Trading Engineering         |
//|  Versiyon: 40.0 (PROFIT FOCUS - MICRO LOT SCALPER)              |
//+------------------------------------------------------------------+
...
input string   InpComment         = "Titanium Omega v40"; // İşlem Yorumu
...
int OnInit()
{
   ...
   // v40 - Başlangıç Mesajı
   Print("=================================================");
   Print("TITANIUM OMEGA v40.0 - PROFIT-FOCUSED MICRO LOT");
   Print("=================================================");
   Print("💰 Bakıye: ", AccountInfoDouble(ACCOUNT_BALANCE), " ", AccountInfoString(ACCOUNT_CURRENCY));
   Print("🎯 SL/TP: ", InpSL_Pips, "/", InpTP_Pips, " pips (R:R 1:", DoubleToString((double)InpTP_Pips/InpSL_Pips, 2), ")");
   Print("📊 Lot: ", InpFixedLot, " (Mikro lot optimizasyonu)");
   Print("✅ Scalping Mode: AKTIF");
   Print("=================================================");
...
void OnTick()
{
   ...
   if(InpShowDashboard || InpForceShowDashboard)
   {
      ...
      string dash = "+================================================+\n";
      dash += "|   TITANIUM OMEGA v40.0 PROFIT-FOCUSED        |\n";
      dash += "+================================================+\n";
