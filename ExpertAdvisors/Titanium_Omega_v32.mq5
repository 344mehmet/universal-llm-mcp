//+------------------------------------------------------------------+
//|                                     Titanium_Omega_v32.mq5       |
//|                     © 2025, Systemic Trading Engineering         |
//|  Versiyon: 32.0 (TRIPLE MA SIGNAL - EASY TREND CATCH)           |
//+------------------------------------------------------------------+
...
input string   InpComment         = "Titanium Omega v32"; // İşlem Yorumu
...
int OnInit()
{
   ...
   Print("=");
   Print("TITANIUM OMEGA v32.0 TRIPLE MA BAŞLATILDI");
...
void OnTick()
{
   ...
   if(InpShowDashboard || InpForceShowDashboard)
   {
      ...
      string dash = "+================================================+\n";
      dash += "|   TITANIUM OMEGA v32.0 TRIPLE MA SIGNAL         |\n";
      dash += "+================================================+\n";
