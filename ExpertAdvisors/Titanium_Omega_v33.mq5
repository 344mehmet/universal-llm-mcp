//+------------------------------------------------------------------+
//|                                     Titanium_Omega_v33.mq5       |
//|                     © 2025, Systemic Trading Engineering         |
//|  Versiyon: 33.0 (ANTI-OVERFITTING + ROBUST OPTIMIZATION)        |
//+------------------------------------------------------------------+
...
input string   InpComment         = "Titanium Omega v33"; // İşlem Yorumu
...
int OnInit()
{
   ...
   Print("=");
   Print("TITANIUM OMEGA v33.0 ANTI-OVERFITTING BAŞLATILDI");
...
void OnTick()
{
   ...
   if(InpShowDashboard || InpForceShowDashboard)
   {
      ...
      string dash = "+================================================+\n";
      dash += "|   TITANIUM OMEGA v33.0 ANTI-OVERFITTING        |\n";
      dash += "+================================================+\n";
