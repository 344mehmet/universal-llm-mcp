//+------------------------------------------------------------------+
//|                                     Titanium_Omega_v34.mq5       |
//|                     © 2025, Systemic Trading Engineering         |
//|  Versiyon: 34.0 (STRATEGY TESTER READY + INSTANT TRADE)         |
//+------------------------------------------------------------------+
...
input string   InpComment         = "Titanium Omega v34"; // İşlem Yorumu
...
//--- 10. TEST & DEBUG
input group "=== 10. TEST & DEBUG (v34) ==="
input bool     InpTestMode             = true;     // v34: Test Modu (Hızlı İşlem)
input bool     InpInstantTrade         = true;     // v34: Anında Market Emri (Bekleyen Değil)
input bool     InpRelaxChecks          = true;     // v34: Tester'da Kontrolleri Gevşet
...
public:
   ...
   void PlaceGrid(int direction)
   {
      ...
      // ===============================================================
      // v34: ANINDA MARKET EMRİ (InpInstantTrade = true)
      // ===============================================================
      if(InpInstantTrade)
      {
         double sl = 0, tp = 0;
         ...
         if(direction == 1) // BUY
         {
            ...
            Print("🚀 v34: Market BUY açılıyor... Lot:", DoubleToString(lotToUse, 2), 
            ...
            {
               g_tradesTodayCount++;
               Print("✅ v34: Market BUY başarılı! Ticket:", m_trade.ResultOrder());
            }
            else
            {
               Print("❌ v34: Market BUY hatası: ", m_trade.ResultRetcodeDescription());
            }
         }
         else // SELL
         {
            ...
            Print("🚀 v34: Market SELL açılıyor... Lot:", DoubleToString(lotToUse, 2), 
                  " SL:", DoubleToString(sl, digits), " TP:", DoubleToString(tp, digits));
            ...
            {
               g_tradesTodayCount++;
               Print("✅ v34: Market SELL başarılı! Ticket:", m_trade.ResultOrder());
            }
            else
            {
               Print("❌ v34: Market SELL hatası: ", m_trade.ResultRetcodeDescription());
            }
         }
...
void OnTick()
{
   ...
   if(InpShowDashboard || InpForceShowDashboard)
   {
      ...
      string dash = "+================================================+\n";
      dash += "|   TITANIUM OMEGA v34.0 TESTER READY           |\n";
      dash += "+================================================+\n";
