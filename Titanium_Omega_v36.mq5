//+------------------------------------------------------------------+
//|                                     Titanium_Omega_v36.mq5       |
//|                     © 2025, Systemic Trading Engineering         |
//|  Versiyon: 36.0 (DEBUG DIAGNOSTICS + TRADE TROUBLESHOOTING)     |
//+------------------------------------------------------------------+
...
input string   InpComment         = "Titanium Omega v36"; // İşlem Yorumu
...
int OnInit()
{
   ...
   Print("✅ v36: Tüm modüller başlatıldı (DEBUG MODE).");
   
   // v36 - Başlangıç Mesajı
   Print("=");
   Print("TITANIUM OMEGA v36.0 DEBUG DIAGNOSTICS BAŞLATILDI");
   ...
   Print("DEBUG: Kapsamlı loglama AKTİF");
   Print("=");
...
void OnTick()
{
   ...
   if(InpShowDashboard || InpForceShowDashboard)
   {
      ...
      string dash = "+================================================+\n";
      dash += "|   TITANIUM OMEGA v36.0 DEBUG DIAGNOSTICS      |\n";
      dash += "+================================================+\n";
