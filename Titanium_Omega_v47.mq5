//+------------------------------------------------------------------+
//|                                     Titanium_Omega_v47.mq5       |
//|                     © 2025, Systemic Trading Engineering         |
//|  Versiyon: 47.0 - PROFIT OPTIMIZED (Karlılık Odaklı)            |
//+------------------------------------------------------------------+
...
//====================================================================
// v47 INPUT PARAMETRELERİ - KARLILIK OPTİMİZE
//====================================================================

//--- 1. ANA AYARLAR
input group "=== 1. MAIN SETTINGS ==="
input ulong    InpMagic           = 474747;    // v47 Magic Number
input string   InpComment         = "Titanium v47"; 
