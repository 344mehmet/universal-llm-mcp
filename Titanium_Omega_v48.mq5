//+------------------------------------------------------------------+
//|                                     Titanium_Omega_v48.mq5       |
//|                     © 2025, Systemic Trading Engineering         |
//|  Versiyon: 48.0 - R:R 1:3 STRATEGY (Karlılık Odaklı)            |
//+------------------------------------------------------------------+
...
//====================================================================
// v48 INPUT PARAMETRELERİ - R:R 1:3 STRATEGY
//====================================================================

//--- 1. ANA AYARLAR
input group "=== 1. MAIN SETTINGS ==="
input ulong    InpMagic           = 484848;    // v48 Magic Number
input string   InpComment         = "Titanium v48"; 
