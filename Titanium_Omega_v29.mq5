//+------------------------------------------------------------------+
//|                                     Titanium_Omega_v29.mq5       |
//|                     © 2025, Systemic Trading Engineering         |
//|     Versiyon: 29.0 (AGGRESSIVE - REVERSE + SCALE + NO LIMITS)   |
//+------------------------------------------------------------------+
...
input string   InpComment         = "Titanium Omega v29"; // İşlem Yorumu
...
void OnTick()
{
   ...
   // v29 - Yeni İşlem Sinyali (Agresif Mantık)
   if(safeToOpen && PositionsTotal() == 0 && OrdersTotal() == 0)
   {
      ...
      if(signal == 0)
      {
         ...
         // Yüksek volatilitede bile sinyal al (v29 agresif)
         // if(regime == REGIME_HIGH_VOLATILITY) signal = 0;
      }
   ...
   // v29 Dashboard - Agresif Gösterim
   if(InpShowDashboard || InpForceShowDashboard)
   {
      ...
      string dash = "+==========================================+\n";
      dash += "|   TITANIUM OMEGA v29.0 AGGRESSIVE MODE   |\n";
      dash += "+==========================================+\n";
      ...
      dash += "+------------------------------------------+\n";
      dash += "| UST USTE KAR  : " + IntegerToString(g_consecutiveWins) + "\n";
      dash += "| UST USTE ZARAR: " + IntegerToString(g_consecutiveLosses) + "\n";
      dash += "| LOT CARPANI   : x" + DoubleToString(g_currentLotMultiplier, 1) + "\n";
      dash += "+------------------------------------------+\n";
