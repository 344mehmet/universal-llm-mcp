...
import { getSharedKnowledgePool, KnowledgeSource } from './core/knowledge-pool.js';
...
export class WebRAGServer {
    private server: ReturnType<typeof createHttpsServer> | ReturnType<typeof createHttpServer> | null = null;
    private port: number;
    ...
    private async handleDebateStart(req: IncomingMessage, res: ServerResponse): Promise<void> {
        ...
        const config = {
            ...
            domains: (body.domains || DEFAULT_DEBATE_CONFIG.domains) as ExpertiseDomain[],
...
let webServerInstance: WebRAGServer | null = null;
