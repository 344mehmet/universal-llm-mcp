...
// Matematik örnekleri
export const MATEMATIK_ORNEKLERI: TrainingSet = {
    category: 'matematik',
    examples: [
...
// Kod örnekleri
export const KOD_ORNEKLERI: TrainingSet = {
    category: 'kod',
    examples: [
...
// Dil örnekleri
export const DIL_ORNEKLERI: TrainingSet = {
    category: 'dil',
    examples: [
...
// Analiz örnekleri
export const ANALIZ_ORNEKLERI: TrainingSet = {
    category: 'analiz',
    examples: [
...
export const UZAYZAMAN_ORNEKLERI: TrainingSet = {
    category: 'uzayzaman',
    examples: [
...
// Tüm setler
export const TUM_EGITIM_SETLERI: TrainingSet[] = [
    MATEMATIK_ORNEKLERI,
    KOD_ORNEKLERI,
    DIL_ORNEKLERI,
    ANALIZ_ORNEKLERI,
 ...
 * Tüm örnekleri yükle
 */
export function loadAllTrainingExamples(): number {
 ...
 */
export function loadCategoryExamples(category: string): number {
    const trainer = getFastTrainer();
