...
export class UniversalLLMServer {
    ...
    registerSystemTools() {
        ...
        this.server.tool('backend_durumu', 'Tüm LLM backend\'lerinin durumunu kontrol et', {}, async () => {
        ...
        // Model listesi aracı
        this.server.tool('model_listele', 'Tüm backend\'lerdeki mevcut modelleri listele', {}, async () => {
            const router = getRouter();
        ...
        this.server.tool('yapilandirma_goster', 'Mevcut sunucu yapılandırmasını göster', {}, async () => {
            const router = getRouter();
